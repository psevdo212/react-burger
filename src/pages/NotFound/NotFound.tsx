  ...
  return (
    <div className={styles.body}>
      <div className={styles.div}>
        ...
        >
          <rect width="1123" height="837" fill="131316" />
      ...
      <div className={styles.text}>
        ...
        <h2 className="text text_type_main-default mb-3">Не можем стартовать :(</h2>
        <h3 className="text text_type_main-default mb-6">Страница не найдена</h3>
        <Button
          onClick={onClick}
          htmlType="button"
          type="primary"
